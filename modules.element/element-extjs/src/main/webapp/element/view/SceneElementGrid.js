 ...
 * @version 1.0.0
 */
Ext.define('kalix.pms.element.view.SceneElementGrid', {
    extend: 'kalix.view.components.common.BaseGrid',
    requires: [
        'kalix.pms.element.controller.MovieElementGridController',
        'kalix.pms.element.store.MovieElementStore'
    ],
    alias: 'widget.sceneElementGrid',
    xtype: 'sceneElementGridPanel',
    autoLoad: false,
    controller: {
        type: 'elementGridController',
        storeId: 'elementStore',
        cfgForm: 'kalix.pms.element.view.SceneElementWindow',
        cfgViewForm: 'kalix.pms.element.view.SceneElementViewWindow',
