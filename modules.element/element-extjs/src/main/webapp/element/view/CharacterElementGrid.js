 ...
 * @version 1.0.0
 */
Ext.define('kalix.pms.element.view.CharacterElementGrid', {
    extend: 'kalix.view.components.common.BaseGrid',
    requires: [
        'kalix.pms.element.controller.MovieElementGridController',
        'kalix.pms.element.store.MovieElementStore'
    ],
    alias: 'widget.characterElementGrid',
    xtype: 'characterElementGridPanel',
    autoLoad: false,
    controller: {
        type: 'elementGridController',
        storeId: 'elementStore',
        cfgForm: 'kalix.pms.element.view.CharacterElementWindow',
        cfgViewForm: 'kalix.pms.element.view.CharacterElementViewWindow',
